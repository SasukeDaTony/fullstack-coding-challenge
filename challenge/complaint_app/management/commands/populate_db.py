            ...
            for complaint in data:
                Complaint.objects.create(
                    ...
                    complaint_type=(
                        ...
                        if "complaint_type" in complaint
                        else None
                    ),
                    descriptor=(
                        complaint["descriptor"] if "descriptor" in complaint else None
                    ),
                    ...
                    council_dist=(
                        ...
                        if "council_dist" in complaint
                        else None
                    ),
                    community_board=(
                        complaint["community_board"]
                        if "community_board" in complaint
                        else None
                    ),
                    closedate=(
                        complaint["closedate"].replace("T00:00:00.000", "")
                        if "closedate" in complaint
                        else None
                    ),
                )
